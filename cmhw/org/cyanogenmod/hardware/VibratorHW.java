...
public class VibratorHW {
    ...
    private static String LEVEL_MAX_PATH = "/sys/vibrator/pwm_max";
    private static String LEVEL_MIN_PATH = "/sys/vibrator/pwm_min";
    private static String LEVEL_DEFAULT_PATH = "/sys/vibrator/pwm_default";
    private static String LEVEL_THRESHOLD_PATH = "/sys/vibrator/pwm_threshold";
